  ...
  return (
    <div className="testimonial-marquee-wrapper">
      <div className="marquee-row">
        ...
        <div className="marquee-inner" id="row1">
          {doubled.map((card, idx) => <div className="testimonial-card" key={"row1-"+idx}>
            <div className="card-header">
              <img src={card.image} alt="User Image" />
            ...
            <p className="card-text">Radiant made undercutting all of our competitors an absolute breeze.</p>
          </div>)}
        </div>
      ...
      <div className="marquee-row">
        <div className="marquee-gradient-left"></div>
        <div className="marquee-inner marquee-reverse" id="row2">
          {doubled.map((card, idx) => <div className="testimonial-card" key={"row2-"+idx}>
            <div className="card-header">
              <img src={card.image} alt="User Image" />
              <div className="card-info">
                <div className="card-title">
