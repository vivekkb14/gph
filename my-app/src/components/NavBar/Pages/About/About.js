          ...
          <div className="middleComponent">
            ...
            <div className="texts">
              ...
              <p className="normalText">
                Dr Ranjith is skilled veterinarian at Global Pet Hospital, known
                for his expertise in animal surgery and preventive care. With a
                focus on compassionate treatment, he ensures the well-being of
                pets through regular check-ups, vaccinations, and emergency
                care, earning the trust of pet owners in the community. He
                earned his Masters in Veterinary at Bangalore Veterinary
                College. He manages our team and makes sure all our backgrounds
                work together to help support our organisation.
              </p>
            </div>
          </div>
          {/* <div className='middleComponent'>
        ...
        <div className="component">
          ...
          <div className="middleComponent">
            ...
            <div className="texts">
              ...
              <p className="normalText">
                Sanjay H M is manager in Global Pet Hospital. He manages pet
                grooming, pet medicines and other internal things. He has three
                years of managerial experience in corporate world. He is
                back-bone of global pet hospital.
              </p>
            </div>
          </div>
          {/* <div className='middleComponent'>
